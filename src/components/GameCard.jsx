...
export default function GameCard(props){
    const Game = {
        ...
        'gameGraphics':props.gameGraphics,
        'gameProcessor':props.gameProcessor,
        'gameDescription':props.gameDescription,
        'gamePercent':props.gamePercent,
    ...
    return (
        ...
        <div className=" flex flex-col items-center max-w-sm max-h-min bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" key={props.index}>
            <img className="rounded-t-lg max-h-48 max-w-48" src={props.imageURL} alt="Default Image" />
            <div className="p-5">
                <h2 className="mb-3 py-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">{props.gameName}</h2>
                <p className="mb-3 text-2xl font-bold text-gray-700 dark:text-gray-400">{props.gamePercent}% Can Play!</p>
