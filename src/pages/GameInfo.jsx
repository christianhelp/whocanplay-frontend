        ...
        <div>
           {
            ...
            <div className=' pl-24 flex flex-col items-center justify-center'>
                ...
                <p className='text-6xl border-b-purple-400 border-b-8'>{Game.gamePercent}% Can Play!</p>
                ...
                <div className='flex  items-center justify-center pt-12 pr-8'>
                    ...
                    <div className='flex bg-slate-400 h-auto border-purple-400 border-2 rounded-lg flex-col  justify-center items-center'>
                        <img className=' max-w-xs' src={Game.imageURL} alt="" />
                        <b className="text-2xl">About:</b>
                        <p className="mb-3  max-w-sm font-normal dark:text-gray-200"> {Game.gameDescription}</p>
                        <div className='pb-6'>
