...
export default function Credits(){
    ...
    return (
        <div className=" flex flex-col items-center justify-center h-auto w-full pt-3">
            ...
            <div className="flex w-full">
                ...
                bio={"Hello, I'm Lauren! (she/her). I'm a senior at UTSA. I'm studying CS with a focus in Cybersecurity. I helped Christian and Caroline here and there with the design of the front and backend respectively. Overall, my favorite part of this project was developing the algorithm that would evaluate the data."}
